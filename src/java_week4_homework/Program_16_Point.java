...
public class Program_16_Point {
    ...
    public double distance(java_week4_homework.Program_16_Point secondPoint) {
        return distance(secondPoint.x, secondPoint.y);
    }

    public static void main(String[] args) {
        java_week4_homework.Program_16_Point first = new java_week4_homework.Program_16_Point(6, 5);
        java_week4_homework.Program_16_Point second = new java_week4_homework.Program_16_Point(3, 1);
        System.out.println("distance(0,0)= " + first.distance());
        System.out.println("distance(second)= " + first.distance(second));
        System.out.println("distance(2,2)= " + first.distance(2, 2));
        java_week4_homework.Program_16_Point point = new java_week4_homework.Program_16_Point();
        System.out.println("distance()= " + point.distance());
    }
}
